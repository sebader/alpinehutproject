...
const messages = {
   en: {
      ...
      infoPage: {
         infoHeader: 'Welcome',
         firstParagraph:'This is a list of alpine huts from two sources: huts connected to the central booking system of the alpine clubs of Switzerland, Austria, Germany, Slovenia and Southern-Tyrol (Italy), as well as huts from huetten-holiday.com.',
         secondParagraph: 'Important: This is a private project with no connection to the alpine clubs or huetten-holiday.com. There is no guarantee about the correctness of the data shown.',
   ...
   de: {
      ...
      mapPage: {
         ...
         noAvailabilityInfo: 'Keine Information verfügbar. Bitte direkt auf der Buchungsseite nachsehen.',
         anyBeds: 'egal',
         zoomIn: 'Zoom',
      },
      hutListPage: {
      ...
      infoPage: {
         ...
         firstParagraph:'Dies ist eine Liste von Berghütten aus zwei Quellen: Hütten, die mit dem zentralen Buchungssystem der Alpenvereine der Schweiz, Österreich, Deutschland, Slowenien und Südtirol (Italien) verbunden sind, sowie Hütten von huetten-holiday.com.',
         secondParagraph: 'Wichtig: Dies ist ein privates Projekt ohne Verbindung zu den Alpenvereinen oder huetten-holiday.com. Alle Angaben sind ohne Gewähr.',
